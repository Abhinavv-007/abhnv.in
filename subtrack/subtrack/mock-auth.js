...
(function () {
    ...
    function logout() {
        clearSession();
        window.location.href = '/subtrack/index.html';
    }
    ...
    function protectPage() {
        ...
        const protectedPages = ['/subtrack/dashboard', '/subtrack/dashboard.html'];
        const currentPath = window.location.pathname;

        if (protectedPages.some(page => currentPath.includes(page))) {
            if (!isAuthenticated()) {
                console.log('[AUTH] Redirecting to login - not authenticated');
                window.location.href = '/subtrack/login.html';
                return false;
            }
    ...
    function redirectIfAuthenticated() {
        const authPages = ['/subtrack/login', '/subtrack/register', '/subtrack/login.html', '/subtrack/register.html'];
        const currentPath = window.location.pathname;
