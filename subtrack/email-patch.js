...
(function () {
    ...
    const imagePathMap = {
        ...
        // Defaut Maps
        'mascot-1.png': '/images/onboarding/mascot-1.png',
        'mascot-2.png': '/images/onboarding/mascot-2.png',
        'mascot-3.png': '/images/onboarding/mascot-3.png',
        'mascot-4.png': '/images/onboarding/mascot-4.png',
    };
    ...
    function fixSubTrackLogo() {
        try {
            ...
            logos.forEach(logo => {
                ...
                if (logo.src.includes('/_next/image') || logo.srcset) {
                    logo.src = '/_static/logo/logo.png';
    ...
    function fixDemoPage() {
        ...
        if (window.location.pathname.includes('/demo') || window.location.href.includes('demo')) {
            try {
        ...
        try {
            ...
            images.forEach(img => {
                ...
                if (currentSrc.includes('/_next/image')) {
                    ...
                    if (isArticleLink) {
                        if (currentSrc.includes('mascot-1.png')) newMascot = '/images/onboarding/mascot-5.png';
                        else if (currentSrc.includes('mascot-2.png')) newMascot = '/images/onboarding/mascot-6.png';
                        else if (currentSrc.includes('mascot-4.png')) newMascot = '/images/onboarding/mascot-7.png';
                        else if (currentSrc.includes('mascot-6.png')) newMascot = '/images/onboarding/mascot-8.png';
                    } else {
                        // Ensure Top Section (Category Links) use correct base mascots (1-4)
                        if (currentSrc.includes('mascot-1.png')) newMascot = '/images/onboarding/mascot-1.png';
                        else if (currentSrc.includes('mascot-2.png')) newMascot = '/images/onboarding/mascot-2.png';
                        else if (currentSrc.includes('mascot-3.png')) newMascot = '/images/onboarding/mascot-3.png';
                        else if (currentSrc.includes('mascot-4.png')) newMascot = '/images/onboarding/mascot-4.png';
                    }
