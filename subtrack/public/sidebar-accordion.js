...
(function () {
    ...
    function getRelativePathPrefix() {
        ...
        if (path.includes('/help/getting-started/') ||
            path.includes('/help/subscriptions/') ||
            path.includes('/help/family/') ||
            path.includes('/help/billing/') ||
            path.includes('/help/account/') ||
            path.includes('/help/troubleshooting/')) {
            return '../';
        }
        return './'; // Fallback
    }
