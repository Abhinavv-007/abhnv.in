...
// .wrangler/tmp/bundle-PqTShT/checked-fetch.js
...
__name(computeChainHash, "computeChainHash");
async function computeSnapshotHash(chainHead, ballotCount, closedAt) {
...
app.post("/api/cast", async (c) => {
  try {
    ...
    const cast_at = (/* @__PURE__ */ new Date()).toISOString();
...
app.post("/api/close", async (c) => {
  try {
    ...
    const closed_at = (/* @__PURE__ */ new Date()).toISOString();
...
// .wrangler/tmp/bundle-PqTShT/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-PqTShT/middleware-loader.entry.ts
